...
SECRET_KEY = 'django-insecure-zheh3c9m#h+k2^4oqjk87x=f_b!y@7n6limb-*2zlj@%)@!fi('
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A simple Product and Order API that helps us lear Django REST Framework',
    'VERSION': '1.0.0',
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",             # Redis provide 16 (0 -15) databases. We are using /1 database 
        "OPTIONS": {
